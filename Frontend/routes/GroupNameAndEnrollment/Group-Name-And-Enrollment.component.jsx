...
import {
  ...
  CreateChapterText,
  CustomButton,
} from "./Group-Name-And-Enrollment.styles";
...
const GroupNameAndEnrollmentPage = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#111313" }}>
      <ScrollView contentContainerStyle={Container}>
        <TitleContainer>
          <Title>Group Name and Enrollment</Title>
        </TitleContainer>
        <InputContainer>
          <Input
          ...
          <CustomButton onPress={pickImage}>
            ...
            />
            <Text style={{ color: "#ffffff" }}>choose Group profile picture</Text>
          </CustomButton>
          {image && (
            <Image
        ...
        <ButtonContainer>
          ...
          >
            <MultiSelect
              ...
              labelField="label"
              valueField="value"
              placeholder="select the Course to Enroll"
          ...
          <CreateButton onPress={handleCreateCourse}>
            <CreateButtonText>Create Group</CreateButtonText>
          </CreateButton>
        </ButtonContainer>
      </ScrollView>
    </SafeAreaView>
...
export default GroupNameAndEnrollmentPage;
